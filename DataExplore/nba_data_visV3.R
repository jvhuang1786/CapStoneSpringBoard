...
str(df)
data<-df
data$tmsalary<-gsub("\\$","",data$tmsalary)
data$tmsalary<-gsub(",","",data$tmsalary)
data$tmsalary<-as.numeric(data$tmsalary)

#
salcap<-read.csv("salarycap.csv", header = F)
colnames(salcap)[1:2]<- c("PlayerYear", "SalCap")

data<-merge(data, salcap, by="PlayerYear")
str(data)
data$SalCap<-gsub("\\$","",data$SalCap)
data$SalCap<-gsub(",","",data$SalCap)
data$SalCap<-as.numeric(data$SalCap)
data$name <-as.character(data$name)
data <- data[,-57]
colnames(data)[56] <- "SalCap"
str(data)
which(is.na(data$TeamWins))
...
data[i = PlayerYear == 2017 & team == "CHO", 
     j = TeamWins := 36]
data[i = PlayerYear == 2016 & team == "CHO", 
     j = TeamWins := 48]
data[i = PlayerYear == 2015 & team == "CHO", 
     j = TeamWins := 33]
data[i = PlayerYear == 2014 & team == "CHO", 
     j = TeamWins := 43]
data[i = PlayerYear == 2013 & team == "CHO", 
     j = TeamWins := 21]
data[i = PlayerYear == 2012 & team == "CHO", 
     j = TeamWins := 7]
data[i = PlayerYear == 2011 & team == "CHO", 
     j = TeamWins := 34]
data[i = PlayerYear == 2010 & team == "CHO", 
     j = TeamWins := 44]
data[i = PlayerYear == 2009 & team == "CHO", 
     j = TeamWins := 35]
data[i = PlayerYear == 2008 & team == "CHO", 
     j = TeamWins := 32]
data[i = PlayerYear == 2007 & team == "CHO", 
     j = TeamWins := 33]
data[i = PlayerYear == 2006 & team == "CHO", 
     j = TeamWins := 26]
data[i = PlayerYear == 2005 & team == "CHO", 
     j = TeamWins := 18]
data[i = PlayerYear == 2004 & team == "CHO", 
     j = TeamWins := NA]
data[i = PlayerYear == 2003 & team == "CHO", 
     j = TeamWins := NA]
data[i = PlayerYear == 2002 & team == "CHO", 
     j = TeamWins := 44]
data[i = PlayerYear == 2001 & team == "CHO", 
     j = TeamWins := 46]
data[i = PlayerYear == 2000 & team == "CHO", 
     j = TeamWins := 49]
which(is.na(data$TeamWins))
...
getwd()
data<-read.csv("2018_2000_data.csv")
data<- data %>% mutate(overUnder = tmsalary/SalCap)
data <- data[,-1]
write.csv(data, file = "2018_2000_data.csv")
#top 10 paying international countries not USA 
...
ggplot(data, aes(three)) +geom_density()
...
midexc2011<-subset(datatest, PlayerYear==2011 & overUnder > 1.05,
...
midexc2010<-subset(datatest, PlayerYear==2010 & overUnder > 1.05,
                   select = c(team, tmsalary, salary))
...
midexc2009<-subset(datatest, PlayerYear==2009 & overUnder > 1.05,
                   select = c(team, tmsalary, salary))
...
med_2009 <-subset(data, PlayerYear==2009 & salary <= 6159901 & salary >= 3695940 & DraftYear != 2009 & Age >= 23,
                  select = c(name,PlayerYear,salary,height_cm,PlusMinus,MinGames, ppg, EFG, Games,
                             started))
midexc2008<-subset(datatest, PlayerYear==2008 & overUnder > 1.05,
                   select = c(team, tmsalary, salary))
...
med_2008 <- subset(data, PlayerYear==2008 & salary <= 5989402 & salary >= 3593641 & DraftYear != 2008 & Age >= 23,
                   select = c(name,PlayerYear,salary,height_cm,PlusMinus,MinGames, ppg, EFG, Games,
                              started))
midexc2007<-subset(datatest, PlayerYear==2007 & overUnder > 1.05,
                   select = c(team, tmsalary, salary))
...
med_2007 <- subset(data, PlayerYear==2007 & salary <= 5574685 & salary >= 3344811 & DraftYear != 2007 & Age >= 23,
                   select = c(name,PlayerYear,salary,height_cm,PlusMinus,MinGames, ppg, EFG, Games,
                              started))
midexc2006<-subset(datatest, PlayerYear==2006 & overUnder > 1.05,
                   select = c(team, tmsalary, salary))
mean(midexc2006$salary)

med_2006 <- subset(data, PlayerYear==2006 & salary <= 5989402 & salary >= 3593641 & DraftYear != 2006 & Age >= 23,
                   select = c(name,PlayerYear,salary,height_cm,PlusMinus,MinGames, ppg, EFG, Games,
                              started))
midexc2007<-subset(datatest, PlayerYear==2007 & overUnder > 1.05,
                   select = c(team, tmsalary, salary))
mean(midexc2007$salary)
med_2005 <-subset(data, PlayerYear==2005 & salary <= 5989402 & salary >= 3593641 & DraftYear != 2005 & Age >= 23,
                  select = c(name,PlayerYear,salary,height_cm,PlusMinus,MinGames, ppg, EFG, Games,
                             started))
midexc2007<-subset(datatest, PlayerYear==2007 & overUnder > 1.05,
                   select = c(team, tmsalary, salary))
mean(midexc2007$salary)
med_2004 <-subset(data, PlayerYear==2004 & salary <= 5989402 & salary >= 3593641 & DraftYear != 2004 & Age >= 23,
                  select = c(name,PlayerYear,salary,height_cm,PlusMinus,MinGames, ppg, EFG, Games,
                             started))
midexc2007<-subset(datatest, PlayerYear==2007 & overUnder > 1.05,
                   select = c(team, tmsalary, salary))
mean(midexc2007$salary)
med_2003 <-subset(data, PlayerYear==2003 & salary <= 5989402 & salary >= 3593641 & DraftYear != 2003 & Age >= 23,
                  select = c(name,PlayerYear,salary,height_cm,PlusMinus,MinGames, ppg, EFG, Games,
                             started))
midexc2007<-subset(datatest, PlayerYear==2007 & overUnder > 1.05,
                   select = c(team, tmsalary, salary))
mean(midexc2007$salary)
med_2002 <-subset(data, PlayerYear==2002 & salary <= 5989402 & salary >= 3593641 & DraftYear != 2002 & Age >= 23,
                  select = c(name,PlayerYear,salary,height_cm,PlusMinus,MinGames, ppg, EFG, Games,
                             started))
midexc2007<-subset(datatest, PlayerYear==2007 & overUnder > 1.05,
                   select = c(team, tmsalary, salary))
mean(midexc2007$salary)
med_2001 <-subset(data, PlayerYear==2001 & salary <= 5989402 & salary >= 3593641 & DraftYear != 2001 & Age >= 23,
                  select = c(name,PlayerYear,salary,height_cm,PlusMinus,MinGames, ppg, EFG, Games,
                             started))
midexc2007<-subset(datatest, PlayerYear==2007 & overUnder > 1.05,
                   select = c(team, tmsalary, salary))
mean(midexc2007$salary)
med_2000 <- subset(data, PlayerYear==2000 & salary <= 5989402 & salary >= 3593641 & DraftYear != 2000 & Age >= 23,
                   select = c(name,PlayerYear,salary,height_cm,PlusMinus,MinGames, ppg, EFG, Games,
                              started))
