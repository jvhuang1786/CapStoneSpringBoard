...
k1<-ggplot(mamba, aes(Age, salary, color = MinGames)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green")+
  ggtitle("Kobe NBA Life Cycle")
...
k2<-ggplot(kobevsAv, aes(x=PlayerYear, y = salary, fill = Type, color = ppg)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green") +
  ggtitle("Kobe vs Avg Joe")
...
kg1<-ggplot(ticket, aes(Age, salary, color = MinGames)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green") +
  ggtitle("Kevin Garnett Life Cycle")
...
kg2<-ggplot(kevinvsAv, aes(x=PlayerYear, y = salary, fill = Type, color = ppg)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green") +
  ggtitle("Garnett vs Avg Joe")
grid.arrange(kg1, kg2, ncol = 2)
```
...
m1<-ggplot(ginob, aes(Age, salary, color = MinGames)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green") + 
  ggtitle("Manu Life Cycle")
#Compare to the average joe 
ginob[,"Type"] <- "Star"
...
m2<-ggplot(ginvsAv, aes(x=PlayerYear, y = salary, fill = Type, color = ppg)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green") +
  ggtitle("Manu vs Avg Joe")
...
pa1<-ggplot(parker, aes(Age, salary, color = MinGames)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green") +
  ggtitle("Parker Life Cycle")
#Compare to the average joe 
parker[,"Type"] <- "Star"
...
pa2<-ggplot(parkervsAv, aes(x=PlayerYear, y = salary, fill = Type, color = ppg)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green") +
  ggtitle("Parker vs Avg Joe")
...
#salary in relation to the age and mins per game 
dl1<-ggplot(dunleavy, aes(Age, salary, color = MinGames)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green") +
  ggtitle("Dunleavy Life Cycle")
...
dl2<-ggplot(dunleavyvsAv, aes(x=PlayerYear, y = salary, fill = Type, color = ppg)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green") +
  ggtitle("Dunleavy vs Avg Joe")
grid.arrange(dl1, dl2, ncol = 2)
```
...
#salary in relation to the age and mins per game 
df1<-ggplot(dfisher, aes(Age, salary, color = MinGames)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green") +
  ggtitle("Fisher Lifecycle")
#Compare to the average joe 
dfisher[,"Type"] <- "Role"
...
df2<-ggplot(dfishervsAv, aes(x=PlayerYear, y = salary, fill = Type, color = ppg)) +
  geom_line() +
  scale_colour_gradient(low = "red",high = "green") +
  ggtitle("Fisher vs Avg Joe")
